...
export const ZENTRA_WINDOWS_PREVIEW_VERSION = '1.79.1';
...
export const ZENTRA_WINDOWS_PREVIEW_SHA256 = '407FAAF6D8866CA97A2B79BB8FB7CFAC9F1729420D21552F95018696104DA786';
export const ZENTRA_WINDOWS_VERSION = ZENTRA_WINDOWS_PREVIEW_VERSION;
export const ZENTRA_MAC_VERSION = '1.79.1';
export const ZENTRA_RELEASE_VERSION = '1.79.1';
export const ZENTRA_GITHUB_RELEASE_PATH = `https://github.com/leartshbj1/zentra/releases/tag/v${ZENTRA_RELEASE_VERSION}`;
export const ZENTRA_ANDROID_VERSION = '1.79.1';
...
export const ZENTRA_IPHONE_VERSION = '1.79.1';
...
export const ZENTRA_MAC_DMG_SIZE_MIB = '48,36';
export const ZENTRA_MAC_DMG_SHA256 =
  '451AB088C7FF82E6D11834E9A8F45AABB9F8B31AF41FD9E14F1A26E9060CBEA1';
