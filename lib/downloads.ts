...
export const ZENTRA_WINDOWS_PREVIEW_VERSION = '1.80.3';
...
export const ZENTRA_WINDOWS_PREVIEW_SHA256 = 'DD74E5F6CECD4DF9553C589E10FB1B03C285764B78B4492343634B4AFE88D8A2';
export const ZENTRA_WINDOWS_VERSION = ZENTRA_WINDOWS_PREVIEW_VERSION;
export const ZENTRA_MAC_VERSION = '1.80.3';
export const ZENTRA_RELEASE_VERSION = '1.80.3';
export const ZENTRA_GITHUB_RELEASE_PATH = `https://github.com/leartshbj1/zentra/releases/tag/v${ZENTRA_RELEASE_VERSION}`;
export const ZENTRA_ANDROID_VERSION = '1.80.3';
...
export const ZENTRA_IPHONE_VERSION = '1.80.3';
...
export const ZENTRA_MAC_DMG_SIZE_MIB = '48,45';
export const ZENTRA_MAC_DMG_SHA256 =
  'D17231AD83282B9CC85959FD2B6C461E40F606004CEB3DBBED8335C94B02C3BA';
