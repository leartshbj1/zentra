...
export const ZENTRA_WINDOWS_PREVIEW_VERSION = '1.84.0';
...
export const ZENTRA_WINDOWS_PREVIEW_SHA256 = '45D33C8DDF4FEADB1B3799ABF91D04D92790AF694BFEFC3E752EF00EBAE5A407';
export const ZENTRA_WINDOWS_VERSION = ZENTRA_WINDOWS_PREVIEW_VERSION;
export const ZENTRA_MAC_VERSION = '1.84.0';
export const ZENTRA_RELEASE_VERSION = '1.84.0';
export const ZENTRA_GITHUB_RELEASE_PATH = `https://github.com/leartshbj1/zentra/releases/tag/v${ZENTRA_RELEASE_VERSION}`;
export const ZENTRA_ANDROID_VERSION = '1.84.0';
...
export const ZENTRA_IPHONE_VERSION = '1.84.0';
...
export const ZENTRA_INSTALLER_SIZE_MIB = '22,67';
...
export const ZENTRA_MAC_DMG_SIZE_MIB = '48,50';
export const ZENTRA_MAC_DMG_SHA256 =
  'D34850C698DC49289EA333AABE2F02BC5568284A946D3043052F1B017E46A1BB';
