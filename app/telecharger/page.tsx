        ...
        <section aria-labelledby="windows-preview-title" className="mx-auto max-w-7xl px-5 pt-8 lg:px-8">
          <div className="flex flex-col gap-5 rounded-3xl border border-[#d5dad5] bg-white p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 max-w-2xl">
              ...
              <p className="mt-3 text-base leading-7 text-[#667169]">Windows 1.67.1 corrige les blocages du partage et simplifie les invitations. Dans Paramètres → Compte et équipe, créez un lien : toute l’entreprise est partagée, avec ses documents, montants, logo et salaires. Filtrez aussi les devis et factures par créateur.</p>
              <p className="mt-3 text-sm leading-6 text-[#667169]">Le correctif de partage 1.67.1 est disponible sur Windows. Les téléchargements Mac et iPhone restent en version 1.67.0 et ne contiennent pas encore ce correctif.</p>
