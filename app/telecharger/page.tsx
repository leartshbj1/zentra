        ...
        <section aria-labelledby="windows-preview-title" className="mx-auto max-w-7xl px-5 pt-8 lg:px-8">
          <div className="flex flex-col gap-5 rounded-3xl border border-[#d5dad5] bg-white p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 max-w-2xl">
              ...
              <p className="mt-3 text-base leading-7 text-[#667169]">La version 1.70.0 vérifie les changements de votre équipe toutes les 3 secondes lorsque Zentra est ouverte et connectée. Une facture ou un paiement reçu actualise les montants de l’accueil automatiquement. Sur mobile, l’interface garde sa taille et les documents conservent leur zoom à deux doigts.</p>
