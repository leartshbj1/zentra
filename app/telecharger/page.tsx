        ...
        <section aria-labelledby="windows-preview-title" className="mx-auto max-w-7xl px-5 pt-8 lg:px-8">
          <div className="flex flex-col gap-5 rounded-3xl border border-[#d5dad5] bg-white p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 max-w-2xl">
              ...
              <p className="mt-3 text-base leading-7 text-[#667169]">Zentra 1.73 enrichit Automation sur Mac et mobile : réglages partagés, bilan quotidien de l’équipe et outils adaptés à chaque écran. L’option reste liée à l’entreprise ; ses collaborateurs en bénéficient avec leurs droits habituels.</p>
              ...
              <p className="mt-3 text-sm leading-6 text-[#667169]">Windows 1.73 reste en validation. La version Windows 1.72 et son canal de mise à jour sont conservés pour le moment.</p>
