            ...
            <div>
              ...
              <div className="mt-7 space-y-3">
                {[
                  ...
                  'Votre logo sur les devis, factures et comptes annuels, dès la configuration de votre entreprise',
                  'Personnalisez les couleurs et la présentation de vos documents avec un véritable aperçu PDF',
