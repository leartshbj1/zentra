        ...
        <section aria-labelledby="windows-preview-title" className="mx-auto max-w-7xl px-5 pt-8 lg:px-8">
          <div className="flex flex-col gap-5 rounded-3xl border border-[#d5dad5] bg-white p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 max-w-2xl">
              ...
              <h2 id="windows-preview-title" className="mt-2 text-2xl font-semibold tracking-tight text-[#17231d]">Votre salaire, guidé jusqu’au bout.</h2>
              <p className="mt-3 text-base leading-7 text-[#667169]">Un champ à corriger ? Zentra l’explique et vous y amène directement. Après une modification, recalculez le salaire depuis le récapitulatif, sans perdre vos montants ni vos notes. Les guides vous accompagnent pour les dates, les assurances et la caisse de pension. Depuis Windows 1.50, utilisez le bouton Mise à jour dans l’app. Pour une version plus ancienne, téléchargez l’installateur ci-contre.</p>
            </div>
