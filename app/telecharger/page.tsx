        ...
        <section aria-labelledby="windows-preview-title" className="mx-auto max-w-7xl px-5 pt-8 lg:px-8">
          <div className="flex flex-col gap-5 rounded-3xl border border-[#d5dad5] bg-white p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 max-w-2xl">
              ...
              <p className="mt-3 text-base leading-7 text-[#667169]">Choisissez la police et la taille de chaque passage dans vos modèles de devis, factures, bilans et fiches de salaire, avec gras, couleurs, logo et mise en page. Saisissez simplement les heures et les minutes, retrouvez le coût du collaborateur et préparez vos factures en conservant votre sélection, même après une erreur.</p>
