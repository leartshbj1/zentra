  ...
  return (
    <>
      ...
      >
        <section
          id="accueil"
          className="home-hero mx-auto w-full max-w-7xl px-5 lg:px-8"
        >
          <div className="home-hero__intro">
            <p className="home-hero__eyebrow">
              Zentra Gestion · pour les PME suisses
            </p>
            <h1>
              Votre entreprise.
              <br />
            ...
            <p className="home-hero__description">
              Devis, factures, projets et salaires.
              <br className="hidden sm:block" /> Tout votre quotidien, dans un
              espace simple.
            </p>
            <div className="home-hero__actions">
              ...
              <a href="#workflow" className="home-hero__link">
                Découvrir le logiciel <ArrowRight className="size-4" />
              </a>
            </div>
            <p className="home-hero__price">
              Dès 49 CHF / mois · Démonstration sans compte
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-[#647068]">
                Votre appareil conserve une copie de travail. Dans une
                entreprise partagée, les modifications enregistrées sont
                envoyées automatiquement aux membres autorisés avec Supabase :
                documents, comptabilité, salaires, logo et réglages. Les
                archives PDF et sauvegardes distantes restent des fonctions
                distinctes.
              </p>
              <a
                href="/security"
