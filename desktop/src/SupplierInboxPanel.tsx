...
export function SupplierInbox({inbox,workspace,readOnly,onOpen,onCreateSupplier}:{inbox:ReturnType<typeof useSupplierInbox>;workspace:Workspace;readOnly:boolean;onOpen:(id:string)=>void;onCreateSupplier:CreateSupplier}){
  useAppLanguage();
