...
const steps: Array<{ view: TourView; eyebrow: string; title: string; text: string; target: string }> = [
  ...
  { view: 'projects', eyebrow: 'Activité', title: 'Pilotez chaque chantier ou projet', text: 'La vue d’ensemble réunit budget, durée, heures, dépenses, facturation et marge. La vue Tâches & jalons montre clairement la prochaine action, son responsable et son échéance.', target: '.project-view-switch' },
