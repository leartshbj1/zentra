...
function TeamScreen({ workspace, query, onCreateEmployee, onEditEmployee, onCreatePayslip, onImportPayslips, onEditPayslip, onPostPayslip, onPrint, onArchiveEmployee, onArchivePayslip }: { workspace: Workspace; query: string; onCreateEmployee: () => void; onEditEmployee: (item: Employee) => void; onCreatePayslip: () => void; onImportPayslips: () => void; onEditPayslip: (item: Payslip) => void; onPostPayslip: (item: Payslip) => void; onPrint: (item: Payslip) => void; onArchiveEmployee: (item: Employee) => void; onArchivePayslip: (item: Payslip) => void }) {
...
function PayslipPrintSheet({ payslip, workspace, onClose }: { payslip: Payslip; workspace: Workspace; onClose: () => void }) {
  ...
  const printedPayslip = frozen ? { ...payslip, period: frozen.period, paymentDate: frozen.paymentDate, notes: frozen.notes, lines: frozen.items } : payslip;
  ...
  const orderedLines = (['earning', 'deduction', 'employer'] as const).flatMap((kind) => printedPayslip.lines.filter((line) => line.kind === kind));
