  ...
  return (
    <div className="desktop-app">
      ...
      <main className="app-main">
        ...
        {notice ? <div className={`notice notice--${notice.tone}`}><span>{notice.tone === 'success' ? <CheckCircle2 size={18} /> : notice.tone === 'warning' ? <MessageSquareWarning size={18} /> : <ShieldCheck size={18} />}{notice.text}</span><button onClick={() => setNotice(null)}><X size={15} /></button></div> : null}
