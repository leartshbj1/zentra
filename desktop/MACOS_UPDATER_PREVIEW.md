...
1. Télécharger `Zentra_1.20.1_macos-universal.dmg` depuis la page officielle
   Zentra.
...
Zentra 1.20.1 contient le canal de mise à jour intégré. Lorsqu’une version plus
