...
test)
  ...
  pnpm --dir desktop exec vitest run src/workspacePreferences.test.ts src/workspacePersonalizationLanguage.test.ts src/nativeNavigationSession.test.ts src/companySyncPresentation.test.ts src/runtimeFinancials.test.ts src/workspaceIndexBridge.test.ts src/runtimePerformance.test.ts 2>&1 | tee desktop/artifacts/validation/personalization-tests.log
