...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            match_bank_customer_credit_refund,
            unmatch_bank_customer_credit_refund,
            ...
            business_sync::snapshot::transport::publication::start_business_publication,
            ...
            business_sync::replay::delivery::incoming::reconciliation::review::inspect_business_conflict_changes,
            business_sync::replay::delivery::incoming::reconciliation::review::read_business_conflict_text,
            business_sync::replay::delivery::incoming::reconciliation::review::list_saved_business_resolutions,
            business_sync::replay::delivery::incoming::reconciliation::review::preview_business_resolution,
            business_sync::replay::delivery::incoming::reconciliation::review::save_business_resolution,
            business_sync::replay::delivery::incoming::reconciliation::review::read_saved_business_resolution,
            ...
            cancel_timer,
            get_active_timer,
            get_timer_recovery_state,
            preserve_active_timer,
            assign_preserved_timer,
            create_backup,
            restore_backup,
            export_json,
            export_csv_archive,
