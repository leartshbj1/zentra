...
const workspace={suppliers:[{id:'vendor',name:'Papeterie du Léman SA',email:'factures@example.test',archivedAt:null}],accounts:[{id:'expense',code:'6500',name:'Charges administratives',accountType:'expense',active:true}]} as Workspace;
