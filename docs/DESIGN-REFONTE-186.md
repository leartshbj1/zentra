...
Ne pas déclarer la refonte complète livrée avant publication vérifiée des paquets. Les 1 646 tests frontend passent ; les corrections de performance du compte sont documentées séparément dans STARTUP-ACCOUNT-OPTIMIZATION-20260924.md.
