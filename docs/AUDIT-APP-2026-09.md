...
| Interface et logique TypeScript | `pnpm --dir desktop test:ui` : 573 tests réussis / 84 fichiers ; `.qa/received-ui.log`. Compilation de l'interface réussie ; `.qa/received-build-final.log`. |
