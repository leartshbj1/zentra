...
2. Brancher le transport natif implémenté sur le planificateur métier et la reprise réseau après cette initialisation ; couvrir toutes les séries actives et les années d'émission. La connexion cloud seule ne déclenche pas encore de réservation.
