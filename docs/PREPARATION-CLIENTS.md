...
| --- | --- | --- |
| Données partagées | Deux installations et deux collaborateurs retrouvent clients, devis, factures, banque, paie et comptabilité. Modifications simultanées et hors ligne conservées ; conflits explicites ; pas de doublon de numérotation ni de journal déséquilibré. | En cours. Les fichiers de projet sont distribués en 1.46.1. Le schéma 60 en préparation conserve les modifications locales et envoie l'historique figé avec ses pièces : essai natif HTTPS de 1 577 lignes, deux documents de projet, un XML TVA et un dossier de clôture réussi, reprise et déduplication vérifiées. Le catalogue version 2 inclut les exports enregistrés, avec vérification des vrais fichiers produits par l'application. Le contenu des fichiers des modifications suivantes est conservé localement avec le journal, y compris après suppression et dans les sauvegardes. Les 742 règles structurelles, les 55 contrôles comptables et financiers (dont totaux devis/factures, paiements, soldes d'avoirs, liens vers les écritures, extournes, TVA sur encaissements historiques et preuves des règlements d'avoirs) et la chaîne de 1 046 entrées d'audit passent en HTTPS sur la version 84 du site ; les règles structurelles passent en 14 requêtes au lieu de 47 après vérification des tables vides ; reprise, empreinte finale identique au natif et nettoyage vérifiés. Les agrégats financiers complets, la publication, l'envoi des modifications suivantes et les conflits restent à terminer ; le partage métier complet est inactif. |
...
| Publication | Sources testées, site déployé, installateurs actuels vérifiés ; installation neuve et mise à jour préservant les données. | Version native 1.46.1 publiée ; site 84 vérifié en HTTPS, manifeste commun conservé. Installation neuve et remplacement Windows réussis ; remplacement Mac réussi avec autorisation normale du Trousseau, données et identité conservées. Signatures d'éditeur et notarisation restent à obtenir. Le schéma 60 et son transport natif ne sont pas distribués. |
