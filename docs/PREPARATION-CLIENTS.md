...
| Reprise après panne | Sauvegarde complète hors appareil, reprise d'un envoi interrompu, restauration sur installation vierge, contrôles d'intégrité et conservation d'une copie de sécurité. | Coffre distant, intégration native et interface implémentés ; tests locaux serveur, restauration et mobile réussis. Publication, essai natif HTTPS et récupération après fin d'abonnement encore à valider. Une sauvegarde ne remplace pas la synchronisation concurrente. |
