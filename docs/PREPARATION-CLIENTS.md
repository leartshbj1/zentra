...
| --- | --- | --- |
| Données partagées | Deux installations et deux collaborateurs retrouvent clients, devis, factures, banque, paie et comptabilité. Modifications simultanées et hors ligne conservées ; conflits explicites ; pas de doublon de numérotation ni de journal déséquilibré. | En cours. Fichiers de projet distribués en 1.46.1. Le schéma 60 en préparation conserve les changements locaux et transmet l'historique figé, documents et exports. Recette native HTTPS du site 88 réussie : 1 766 lignes, reprise sans doublon, 742 contrôles structurels, 93 contrôles comptables, 6 pièces et 14 mouvements clients, puis 1 088 événements d'audit. Factures, avoirs, compensations et remboursements fournisseurs contrôlés ; nettoyage vérifié. La publication atomique de l'historique, sa récupération sur un second profil, les transactions suivantes et les conflits restent à terminer. Partage métier complet inactif. |
...
| Publication | Sources testées, site déployé, installateurs actuels vérifiés ; installation neuve et mise à jour préservant les données. | Version native 1.46.1 publiée ; site 88 vérifié en HTTPS, manifeste commun conservé. Installation neuve et remplacement Windows réussis ; remplacement Mac réussi avec autorisation normale du Trousseau, données et identité conservées. Signatures d'éditeur et notarisation restent à obtenir. Le schéma 60 et son transport natif ne sont pas distribués. |
