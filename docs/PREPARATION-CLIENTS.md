...
| --- | --- | --- |
| Données partagées | Deux installations et deux collaborateurs retrouvent clients, devis, factures, banque, paie et comptabilité. Modifications simultanées et hors ligne conservées ; conflits explicites ; pas de doublon de numérotation ni de journal déséquilibré. | En cours. Fichiers de projet distribués en 1.46.1. Le schéma 60 en préparation conserve les modifications locales et transmet l'historique figé avec les documents et exports enregistrés. Recette native HTTPS du site 87 réussie : 1 698 lignes, cinq références de fichiers, reprise sans doublon et modification locale conservée ; 742 règles structurelles, 69 contrôles comptables, projection exacte de 6 pièces et 14 mouvements, puis 1 071 événements d'audit. Les preuves de reprise des anciens avoirs, leurs journaux et corrections de TVA sont contrôlés. Nettoyage vérifié. Corrections fournisseurs, paie, stocks, publication atomique de l'historique, modifications suivantes et conflits restent à terminer ; partage métier complet inactif. |
...
| Publication | Sources testées, site déployé, installateurs actuels vérifiés ; installation neuve et mise à jour préservant les données. | Version native 1.46.1 publiée ; site 87 vérifié en HTTPS, manifeste commun conservé. Installation neuve et remplacement Windows réussis ; remplacement Mac réussi avec autorisation normale du Trousseau, données et identité conservées. Signatures d'éditeur et notarisation restent à obtenir. Le schéma 60 et son transport natif ne sont pas distribués. |
