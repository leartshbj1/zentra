...
Le premier lot 1.36 a été retenu après la découverte du défaut de focus sous WebKit. Son paquet Windows avait passé la signature, le démarrage et le contrôle du canal HTTPS, mais il n’a pas été publié. Les constructions macOS et mobiles ont été annulées. Le lot 1.37 intègre la correction et doit refaire les vérifications des paquets.
