...
Les scénarios navigateur utilisent exclusivement les données et exports simulés de `desktop/tests`. Ils ne prouvent pas un export natif sur chaque appareil. Cette livraison est locale : elle ne remplace pas la version 1.35 actuellement téléchargeable et ne constitue pas une publication iOS ou Android. Les modifications bancaires déjà en cours dans le dossier de travail restent distinctes de cette refonte et demandent encore leur validation native.
