...
def main():
    ...
    expected_schema = {'1.45.0': 58, '1.46.0': 59, '1.46.1': 59, '1.50.0': 59, '1.51.0': 59, '1.51.1': 59, '1.52.0': 59, '1.53.0': 59, '1.54.0': 59, '1.55.0': 59, '1.56.0': 59, '1.57.0': 59, '1.58.0': 59, '1.59.0': 59}[version]
    ...
    with sqlite3.connect(uri, uri=True, timeout=2) as connection:
        ...
        if mode == 'seed':
            assert version in {'1.45.0', '1.58.0'}
